...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.351238, 221.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.351238, 245.0, 52.0, 23.0 ],
					"style" : "",
					"text" : "play $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.351227, 454.0, 262.0, 33.0 ],
					"style" : "",
					"text" : "In a locked patch, select and COPY the notes you want to keep from the first bach.roll below:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.351227, 454.0, 19.0, 20.0 ],
					"style" : "",
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.351234, 350.0, 116.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.594101, 350.0, 19.0, 20.0 ],
					"style" : "",
					"text" : "2",
					"textcolor" : [ 0.741176, 0.356863, 0.047059, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.851227, 324.0, 19.0, 20.0 ],
					"style" : "",
					"text" : "1",
					"textcolor" : [ 0.741176, 0.356863, 0.047059, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.851227, 374.0, 49.0, 20.0 ],
					"style" : "",
					"text" : "velocity",
					"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.851242, 374.0, 42.0, 20.0 ],
					"style" : "",
					"text" : "note #",
					"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.851227, 324.0, 139.0, 20.0 ],
					"style" : "",
					"text" : "<= select MIDI keyboard",
					"textcolor" : [ 0.011765, 0.396078, 0.752941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.351238, 401.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "<live.text>",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.851242, 296.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "midiinfo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 169.851242, 324.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 169.851242, 246.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 235.351242, 397.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.351242, 423.0, 139.053711, 22.0 ],
					"style" : "",
					"text" : "pack i i 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 98.351234, 402.0, 80.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.351234, 423.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "allnotesoff"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 235.351242, 350.0, 139.053711, 22.0 ],
					"style" : "",
					"text" : "notein"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"patching_rect" : [ 98.351234, 454.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 491.666656, 73.0, 20.0 ],
					"style" : "",
					"text" : "<bach.roll>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 98.351234, 527.666626, 552.0, 120.333336 ],
					"pitcheditrange" : [ "null" ],
					"ruler" : 3,
					"showplayhead" : 1,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 388.351227, 364.021179, 244.0, 75.0 ],
					"viewvisibility" : 1
				}
