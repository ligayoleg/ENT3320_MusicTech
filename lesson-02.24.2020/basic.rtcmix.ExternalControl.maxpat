...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 126.0, 200.5, 33.0 ],
					"style" : "",
					"text" : "<= send a band every 2000 ms (retrigers a script)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 47.5, 308.0, 20.0 ],
					"style" : "",
					"text" : "<= turn on to hear your sequence in continous loop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.5, 122.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 39.5, 47.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.5, 363.0, 78.0, 20.0 ],
					"style" : "",
					"text" : "<live.gain~>",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.5, 180.0, 30.0, 20.0 ],
					"style" : "",
					"text" : "<b>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.5, 180.0, 199.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.5, 214.571426, 156.0, 47.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.5, 273.5, 156.0, 74.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 39.5, 363.0, 136.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 39.5, 445.0, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 39.5, 214.571426, 125.0, 40.0 ],
					"save" : [ "#N", "rtcmix~", 2, 0, ";", "#X", "restore", 0, 446, 446, "// STRUM2 Instrument Syntax:\r\n// STRUM2(outsk, dur, AMP, PITCH, squish, decay_time[, PAN])\n// source: http://rtcmix.org/reference/instruments/STRUM2.php\r\n\r\n\n\r\nstarttime = 0\r\n\r\nfor(i = 0; i < 10; i = i + 1){\r\n\trate = irand (0.0, 1.0) //random number for seconds\r\n\tdillon = irand(300, 700) //random number within range of 300 - 700 hz\r\n\tSTRUM2(starttime, 3.5, 20000, dillon, 2, 3.5, random())\r\n\tstarttime = starttime + rate\r\n}\r\n\r\nMAXBANG(starttime)", ";" ],
					"style" : "",
					"text" : "rtcmix~ 2"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 102.0, 348.0, 166.0, 348.0 ],
					"source" : [ "obj-1", 1 ]
				}
